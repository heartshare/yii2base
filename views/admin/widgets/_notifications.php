...
if (Yii::$app->session->hasFlash('message')):
    ...
    if (is_array($message) && count($message) == 2) {
    ...
    } elseif (is_array($message) && count($message) == 3) {
        ...
        switch($message[0]){
            case 'success':
                $body = '<span class="fa fa-alert fa-2x fa-check-circle-o"></span> <span>' . $message[1] . '</span>';
                break;

            case 'danger':
                $body = '<span class="fa fa-alert fa-2x  fa-exclamation-circle"></span> <span>' . $message[1] . '</span>';
                break;

            case 'warning':
                $body = '<span class="fa fa-alert fa-2x  fa-question-circle"></span> <span>' . $message[1] . '</span>';
                break;

            case 'info':
                $body = '<span class="fa fa-alert fa-2x  fa-info-circle"></span> <span>' . $message[1] . '</span>';
                break;
