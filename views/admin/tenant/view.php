<div class="row">
    <header class="header-ctn col-md-12">
        <div class="brand-view">
            <h1><?= Yii::t('base', 'Tenant') . ": " . $model->name;?></h1>
            <p><?= $model->domain ?></p>
        </div>
    ...
    <section class="main-ctn">
        <div class="inner">
            <ul class="nav nav-tabs tabs-responsive" role="tablist">
                <li class="active"><a href="#general" role="tab" data-toggle="tab"><i class="fa fa-dashboard"></i>
                        General</a></li>
                <li><a href="#users" role="tab" data-toggle="tab"><i class="fa fa-users"></i>
                        Users</a></li>
                <li><a href="#permissions" role="tab" data-toggle="tab"><i class="fa fa-gears"></i> Permissions</a>
                </li>
                                        ...
                                        <div class="row section section-first section-data">
                                            <div class="table-responsive" style="margin-top: 10px;">
                                                <table class="table table-hover tbl-grid">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td><a href="#"><strong>Super Admin</strong></a></td>                                     <td><span class="statusDot statusDot-danger"></span></td>
                                                        <td>
                                                            <div class="btn-group pull-right grid-action-buttons">
                                                    ...
                                                    <tr>
                                                        <td><a href="#"><strong>Admin</strong></a></td>
                                                        <td><span class="statusDot statusDot-danger"></span></td>
                                                        <td>
                                                            <div class="btn-group pull-right grid-action-buttons">
                                                    ...
                                                    <tr>
                                                        <td><a href="#"><strong>Moderator</strong></a></td>
                                                        <td><span class="statusDot statusDot-danger"></span></td>
                                                        <td>
                                                            <div class="btn-group pull-right grid-action-buttons">
