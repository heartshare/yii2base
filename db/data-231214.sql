...
# Database: gxcapp
# Generation Time: 2014-12-23 08:53:38 +0000
# ************************************************************
...
CREATE TABLE `base_tenant_module` (
  ...
  `expiry_mode` tinyint(1) NOT NULL DEFAULT '0',
  `expired_at` datetime DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
  `updated_by` bigint(20) unsigned DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_mode` tinyint(2) DEFAULT NULL,
  `updated_info` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `store_module_unique` (`store`,`module`),
  KEY `module_store` (`module`,`store`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `base_tenant_module` WRITE;
/*!40000 ALTER TABLE `base_tenant_module` DISABLE KEYS */;

INSERT INTO `base_tenant_module` (`id`, `store`, `module`, `plan`, `permissions`, `expiry_mode`, `expired_at`, `status`, `updated_by`, `updated_at`, `updated_mode`, `updated_info`)
VALUES
	(1,'c.e68.f79','base','default','',0,NULL,1,NULL,NULL,NULL,NULL),
	(2,'c.e68.f79','app','default','',0,NULL,1,NULL,NULL,NULL,NULL);

/*!40000 ALTER TABLE `base_tenant_module` ENABLE KEYS */;
UNLOCK TABLES;
...
# Dump of table base_user_permission
# ------------------------------------------------------------
